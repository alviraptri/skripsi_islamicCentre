              ...
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url() . 'c_admin/simpanWaliMurid'; ?>" novalidate>
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">ID Siswa<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6">
                          <input id="idSiswa" class="form-control" name="idSiswa" required="required" type="text" value="<?php echo $this->session->idSiswa; ?>" readonly>
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Orang Tua<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6">
                        <select name="keterangan" class="select2_single form-control">
                            <option>Pilih</option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input id="name" class="form-control" name="nomorInduk" required="required" type="text" value="WM00<?php echo $this->session->idSiswa; ?>" readonly>
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="userRole">Status<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="email2" name="status" data-validate-length-range="11" required="required" class="form-control" value="Wali Murid" readonly>
                        </div>
                      </div>
                      <div class="item form-group">
