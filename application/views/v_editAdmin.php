            ...
            <div class="col-md-12 col-sm-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <?php foreach ($editAdmin as $edit) { ?>
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url() . 'c_admin/updateAdmin'; ?>" novalidate enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input type="number" id="email2" name="noTelp" data-validate-length-range="9" required="required" class="form-control" value="<?= $edit->noTelp ?>" step="0.01">
                        </div>
                      </div>
                      <div class="item form-group">
