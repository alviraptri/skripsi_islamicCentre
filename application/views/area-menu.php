...
<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="<?php echo base_url('c_admin/index'); ?>"><img class="main-logo" src="<?php echo base_url(); ?>assets/admin/img/logo/logoBener.png" alt="" /></a>
            <strong><a href="<?php echo base_url('c_admin/index'); ?>"><img src="<?php echo base_url(); ?>assets/admin/img/logo/logoBener2.png" alt="" /></a></strong>
        </div>
            ...
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="All Students" href="<?php echo base_url('c_admin/siswa'); ?>"><span class="mini-sub-pro">All Students</span></a></li>
