					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							...
							<div class="kt-login__signin">
								...
								<form class="kt-form" action="<?php echo base_url('c_login/login'); ?>" method="post">
									<div class="input-group">
										<input class="form-control" type="text" placeholder="Nomor Induk" name="uname" autocomplete="off" required>
									</div>
									<div class="input-group">
										<input class="form-control" type="password" placeholder="Kata Sandi" name="pass" required>
									</div>
								...
								<div class="kt-login__head">
									<h3 class="kt-login__title"><?php echo $this->session->flashdata('message');?></h3>
								</div>
							</div>
						</div>
					</div>
