...
<head>
    ...
    <title>Tahun Ajaran | Information Academic Islamic Centre</title>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo base_url() . 'c_admin/simpanThnAjaran'; ?>">

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Tahun Ajaran<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="email" name="thnAjaran" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
