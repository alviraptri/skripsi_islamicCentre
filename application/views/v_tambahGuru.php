                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="<?php echo base_url().'c_admin/simpanGuru';?>" method="post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="nomorInduk" type="text" class="form-control" placeholder="Nomor Induk">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="noTelp" type="tel" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}" class="form-control" placeholder="No. Telepone">
