...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url(); ?>assets/internal/vendors/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
		...
		<link href="<?php echo base_url(); ?>assets/internal/css/demo12/style.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<!-- begin:: Header Mobile -->
		<?php include("view-headerMobile.php") ?>
        <!-- end:: Header Mobile -->
												...
												<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
													...
													<div class="kt-timeline-v2__item">
														...
														<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
															<a href="#"><img src="<?php echo base_url(); ?>assets/internal/media/users/100_4.jpg" title=""></a>
															<a href="#"><img src="<?php echo base_url(); ?>assets/internal/media/users/100_13.jpg" title=""></a>
															<a href="#"><img src="<?php echo base_url(); ?>assets/internal/media/users/100_11.jpg" title=""></a>
															<a href="#"><img src="<?php echo base_url(); ?>assets/internal/media/users/100_14.jpg" title=""></a>
														</div>
													</div>
													<div class="kt-timeline-v2__item">
								...
								<div class="col-xl-4">
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget19">
										<div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
											<div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(<?php echo base_url(); ?>assets/internal/media//products/product4.jpg)">
											...
											<div class="kt-widget19__wrapper">
												<div class="kt-widget19__content">
													<div class="kt-widget19__userpic">
														<img src="<?php echo base_url(); ?>assets/internal/media//users/user1.jpg" alt="">
													</div>
												...
												<div class="tab-pane active" id="kt_widget5_tab1_content" aria-expanded="true">
													<div class="kt-widget5">
														<div class="kt-widget5__item">
															<div class="kt-widget5__content">
																<div class="kt-widget5__pic">
																	<img class="kt-widget7__img" src="<?php echo base_url(); ?>assets/internal/media//products/product27.jpg" alt="">
																</div>
														...
														<div class="kt-widget5__item">
															<div class="kt-widget5__content">
																<div class="kt-widget5__pic">
																	<img class="kt-widget7__img" src="<?php echo base_url(); ?>assets/internal/media//products/product22.jpg" alt="">
																</div>
																<div class="kt-widget5__section">
																	<a href="#" class="kt-widget5__title">
																		Branding Mockup
														...
														<div class="kt-widget5__item">
															<div class="kt-widget5__content">
																<div class="kt-widget5__pic">
																	<img class="kt-widget7__img" src="<?php echo base_url(); ?>assets/internal/media//products/product15.jpg" alt="">
																</div>
																<div class="kt-widget5__section">
																	<a href="#" class="kt-widget5__title">
																		Awesome Mobile App
												...
												<div class="tab-pane" id="kt_widget5_tab2_content">
													<div class="kt-widget5">
														<div class="kt-widget5__item">
															<div class="kt-widget5__content">
																<div class="kt-widget5__pic">
																	<img class="kt-widget7__img" src="<?php echo base_url(); ?>assets/internal/media//products/product10.jpg" alt="">
																</div>
																<div class="kt-widget5__section">
																	<a href="#" class="kt-widget5__title">
																		Branding Mockup
														...
														<div class="kt-widget5__item">
															<div class="kt-widget5__content">
																<div class="kt-widget5__pic">
																	<img class="kt-widget7__img" src="<?php echo base_url(); ?>assets/internal/media//products/product11.jpg" alt="">
																</div>
																<div class="kt-widget5__section">
																	<a href="#" class="kt-widget5__title">
																		Awesome Mobile App
														...
														<div class="kt-widget5__item">
															<div class="kt-widget5__content">
																<div class="kt-widget5__pic">
																	<img class="kt-widget7__img" src="<?php echo base_url(); ?>assets/internal/media//products/product6.jpg" alt="">
																</div>
																<div class="kt-widget5__section">
																	<a href="#" class="kt-widget5__title">
																		Great Logo Designn
											...
											<div class="tab-content">
													...
													<div class="kt-widget4">
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_4.jpg" alt="">
															</div>
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_14.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Milano Esco
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_11.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nick Bold
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_1.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Wiltor Delton
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_5.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nick Stone
												...
												<div class="tab-pane" id="kt_widget4_tab2_content">
													<div class="kt-widget4">
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_2.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Kristika Bold
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_13.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Ron Silk
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_9.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nick Bold
														...
														<div class="kt-widget4__item">
															<div class="kt-widget4__pic kt-widget4__pic--pic">
																<img src="<?php echo base_url(); ?>assets/internal/media/users/100_8.jpg" alt="">
															</div>
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username">
																	Nick Bold
										...
										<div class="kt-portlet__body">
											<div class="kt-widget3">
												<div class="kt-widget3__item">
													<div class="kt-widget3__header">
														<div class="kt-widget3__user-img">
															<img class="kt-widget3__img" src="<?php echo base_url(); ?>assets/internal/media/users/user1.jpg" alt="">
														</div>
												...
												<div class="kt-widget3__item">
													<div class="kt-widget3__header">
														<div class="kt-widget3__user-img">
															<img class="kt-widget3__img" src="<?php echo base_url(); ?>assets/internal/media/users/user4.jpg" alt="">
														</div>
														<div class="kt-widget3__info">
															<a href="#" class="kt-widget3__username">
																Lebron King James
												...
												<div class="kt-widget3__item">
													<div class="kt-widget3__header">
														<div class="kt-widget3__user-img">
															<img class="kt-widget3__img" src="<?php echo base_url(); ?>assets/internal/media/users/user5.jpg" alt="">
														</div>
														<div class="kt-widget3__info">
															<a href="#" class="kt-widget3__username">
																Deb Gibson
			...
			<div class="kt-demo-panel__body">
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo1.jpg" alt="" />
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo2.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo3.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo4.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo5.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo6.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo7.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo8.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo9.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo10.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo11.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item kt-demo-panel__item--active">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo12.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo13.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
				...
				<div class="kt-demo-panel__item ">
					...
					<div class="kt-demo-panel__item-preview">
						<img src="<?php echo base_url(); ?>assets/internal/media/demos/preview/demo14.jpg" alt="" />
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
						</div>
					</div>
									...
									<div class="kt-chat__messages kt-chat__messages kt-chat__messages--modal">
										<div class="kt-chat__message kt-bg-light-success">
											<div class="kt-chat__user">
												<span class="kt-userpic kt-userpic--circle kt-userpic--sm">
													<img src="<?php echo base_url(); ?>assets/internal/media/users/100_12.jpg" alt="image">
												</span>
										...
										<div class="kt-chat__message kt-chat__message--right kt-bg-light-brand">
											<div class="kt-chat__user">
												...
												<span class="kt-userpic kt-userpic--circle kt-userpic--sm">
													<img src="<?php echo base_url(); ?>assets/internal/media/users/300_21.jpg" alt="image">
												</span>
											</div>
											<div class="kt-chat__text">
		...
		<script src="<?php echo base_url(); ?>assets/internal/js/demo12/scripts.bundle.js" type="text/javascript"></script>

		<!--end::Global Theme Bundle -->

		<!--begin::Page Vendors(used by this page) -->
		<script src="<?php echo base_url(); ?>assets/internal/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
		<script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM" type="text/javascript"></script>
		<script src="<?php echo base_url(); ?>assets/internal/vendors/custom/gmaps/gmaps.js" type="text/javascript"></script>

		<!--end::Page Vendors -->

		<!--begin::Page Scripts(used by this page) -->
		<script src="<?php echo base_url(); ?>assets/internal/js/demo12/pages/dashboard.js" type="text/javascript"></script>
