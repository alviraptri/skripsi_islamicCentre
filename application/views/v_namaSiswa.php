                                    ...
                                    <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($siswa as $a) { ?>
                                                <tr>
                                                    <td> <?= $a->namaUser; ?></td>
                                                    <td> <?= $a->ketKelas; ?> <?= $a->jurusanKelas; ?> <?= $a->nomorKelas; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url('c_rekomendasi/perbandinganAlternatif/') . $a->idSiswa; ?>">
                                                            <button data-toggle="tooltip" class="btn btn-warning btn-xs">
                                                                Perbandingan <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                                                            </button>
                                                        </a>
                                                    </td>
                                                </tr>
