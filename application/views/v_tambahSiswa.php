                  ...
                  <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url() . 'c_admin/simpanSiswa'; ?>" enctype="multipart/form-data" novalidate>
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <input id="name" class="form-control" name="nomorInduk" required="required" type="text" value="<?= $kodeMurid; ?>" readonly>
                      </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="email2" name="status" data-validate-length-range="11" required="required" class="form-control" value="Siswa" readonly>
                      </div>
                    </div>
                    <div class="item form-group">
