            ...
            <div class="col-md-12 col-sm-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <?php foreach ($editWk as $edit) { ?>
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url() . 'c_admin/updateWaliKelas'; ?>" novalidate enctype="multipart/form-data">
