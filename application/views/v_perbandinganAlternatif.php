                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Perbandingan Alternatif &rarr; 
                                    <?php 
                                ...
                                <div class="x_content">
                                <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url() . 'c_rekomendasi/simpanPerbandinganAlt/'.$this->session->userdata('siswa'); ?>" novalidate>
                                        ...
                                        <tbody name="show_data" id="show_data">
                                            ...
                                            for ($i=0; $i <=($jmlh- 2) ; $i++) { 
                                                for ($j=($i+1); $j <= ($jmlh - 1) ; $j++) { 
                                                    ...
                                                    <tr>
                                                    <td>
                                                        <input type="text" name="idA1<?php echo $urut?>" value="<?= $id[$i]?>" hidden> <?= $nama[$i]?>
                                                        <!-- <input name="pilih<?php echo $urut?>" value="1" checked="" class="hidden" type="radio">
							                            <label><?php echo $nama[$i]; ?></label> -->
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" name="idA2<?php echo $urut?>" value="<?= $id[$j]?>" hidden> <?= $nama[$j]?>
                                                        <!-- <input name="pilih<?php echo $urut?>" value="1" checked="" class="hidden" type="radio">
							                            <label><?php echo $nama[$j]; ?></label> -->
                                                    </td>
                                                </tr>
                                            <?php }
                                            }
