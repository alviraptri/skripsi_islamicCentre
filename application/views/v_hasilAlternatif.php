                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    if ($consRatio > 0.1) { ?>
                                        ...
                                        <!-- <a href='javascript:history.back()'> -->
                                            <button class="ui left labeled icon button" onclick="minus()">
                                ...
                                <a href="<?php echo base_url('c_rekomendasi/perbandinganAlternatif/') . $this->session->userdata('siswa'); ?>">
                                    <button data-toggle="tooltip" class="btn btn-warning btn-xs">
                                        Lanjut <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                                    </button>
                                </a>
                                <a href="<?php echo base_url('c_rekomendasi/hasilAkhir/') . $this->session->userdata('siswa'); ?>">
                                    <button data-toggle="tooltip" class="btn btn-warning btn-xs">
                                        Hasil Akhir <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                                    </button>
                                </a>
                            </div>
                        </div>
