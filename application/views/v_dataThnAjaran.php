              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <li> <a href="<?php echo base_url('c_admin/tambahThnAjaran'); ?>"><button type="submit" class="btn btn-primary">Tambah Tahun Ajaran</button></a>
                    </li>
                  </ul>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <?php foreach ($ta as$list) {?>
                        <tr>
                        <td><?php echo $list->idTahunAjaran?></td>
                          <td><?php echo $list->tahunAjaran ?></td>
                          <td><?php
                                if ($list->statusTahunAjaran == 1) { ?>
                              <button class="btn btn-success btn-xs">Aktif</button>
                            <?php } ?></td>
                          <td>
                              <a href="<?php echo base_url('c_admin/statusThnAjaran/') .$list->idTahunAjaran; ?>">
