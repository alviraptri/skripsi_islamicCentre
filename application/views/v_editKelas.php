                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url() . 'c_admin/updateKelas'; ?>" novalidate>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <?php foreach ($editKelas as $kelas) { ?>
                          <input type="text" id="email" name="idKelas" required="required" class="form-control" value="<?= $kelas->idKelas ?>" readonly>
                        <?php } ?>
                      </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <?php foreach ($editKelas as $kelas) { ?>
                          <input type="text" id="email" name="noKelas" required="required" class="form-control" value="<?= $kelas->nomorKelas ?>">
                        <?php } ?> </div>
                    </div>
