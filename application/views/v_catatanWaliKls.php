                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="myModalLabel">Tambah Catatan</h3>
                        ...
                        <form class="form-horizontal form-label-left">
                            <div class="modal-body">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                       <textarea name="cttn" id="cttn" cols="30" rows="10" class="form-control"></textarea>
                                    </div>
                                </div>
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.nama.length; i++) {
                            html += '<tr>' +
                                ...
                                '<a href="javascript:;" title="Edit" class="btn btn-info btn-xs item_edit" data="' + data.nama[i].idSiswa + '">' +
