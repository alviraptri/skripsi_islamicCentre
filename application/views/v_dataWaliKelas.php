...
<html lang="en">
  <head>
    ...
    <title>Wali Kelas | Information Academic Islamic Centre</title>
                          ...
                          <td>
                            <?php
                              ...
                              <?php
                                  ...
                                  $this->load->view("v_modalWaliKelas", $data);
                                  ?>

                              <a href="<?php echo base_url('c_admin/editWaliKelas/') . $list->nomorInduk; ?>">
                                <button data-toggle="tooltip" title="Edit" class="btn btn-info btn-xs">
                                  <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </button>
                              </a>
                              <a href="<?php echo base_url('c_admin/statusWaliKelas/') . $list->nomorInduk; ?>">
